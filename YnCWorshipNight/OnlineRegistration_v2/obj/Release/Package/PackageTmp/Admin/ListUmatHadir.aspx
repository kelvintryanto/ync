<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListUmatHadir.aspx.cs" Inherits="OnlineRegistration_v2.Admin.ListUmatHadir" %>
...
<body>
    <h1>List Peserta Rejoice yang <strong>HADIR</strong></h1>
        ...
        <asp:GridView ID="gvw_listData" runat="server" CssClass="table table-hover table-bordered" AutoGenerateColumns="False" DataKeyNames="ID"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Status">
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text="HADIR!"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
